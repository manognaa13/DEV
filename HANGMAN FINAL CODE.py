...
bg = PhotoImage(file = "coverpic25.png")
...
def game_tab():
    ...
    root.title("Hangman")
    bg1 = PhotoImage(file = "moonit.png")
    ...
    while run:
        ...
        #exit image printing
            exited=ImageTk.PhotoImage(Image.open('exitt.png'))
            exitbtn=Button(root,image=exited,command=close)
            exitbtn.place(x=1150,y=0)
...
exit1=ImageTk.PhotoImage(Image.open('exitt.png'))
exitbtn1=Button(root1,image=exit1,command=close1)
exitbtn1.place(x=1150,y=0)
...
stop_button=Button(root1,image=stop_m,command=stop)
stop_button.pack()
